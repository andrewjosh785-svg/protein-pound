// mirrors apps/web/src/lib/queries/useMeals.ts
...
const MEAL_SELECT =
  "id, slug, name, servings, serving_size_g, protein_g, carbs_g, fat_g, kcal, is_veggie, time_label, description, method, source, owner_id, category, " +
