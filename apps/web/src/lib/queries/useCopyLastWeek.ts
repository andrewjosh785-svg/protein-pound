...
// Mirrors useCurrentWeekPlan.ts's Monday computation, minus 7 days — strictly the
// immediately preceding calendar week, not "most recent week with any plan."
...
/** Copies last week's planned meals into the current (empty) week — a fresh-week shortcut
 * for users whose meal rotation doesn't change much week to week. Only plan_entries are
 * copied, never log_entries: planned meals are forward-looking intent, logged extras are a
